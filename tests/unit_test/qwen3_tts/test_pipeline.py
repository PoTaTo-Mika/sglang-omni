...
def test_low_vram_example_pins_talker_memory_fraction() -> None:
    config = ConfigManager.from_file(
        "examples/configs/qwen3_tts_1_7b_low_vram.yaml"
    ).config

    assert isinstance(config, Qwen3TTSPipelineConfig)
