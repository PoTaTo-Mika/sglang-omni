...
SERVING_CLOSED16_THROUGHPUT_QPS_REF: float | None = 4.740671873675457
SERVING_CLOSED16_LATENCY_P95_S_REF: float | None = 3.144
SERVING_RAMP_THROUGHPUT_QPS_REF: float | None = 5.487538038414852
...
SERVING_REST_STREAM_TTFA_P95_S_REF: float | None = 0.2961
SERVING_REST_STREAM_INTER_CHUNK_P95_S_REF: float | None = 0.6633
SERVING_REST_STREAM_LATENCY_P95_S_REF: float | None = 0.965
SERVING_REST_STREAM_RTF_P95_REF: float | None = 0.2213
...
SERVING_WS_STREAM_RTF_P95_REF: float | None = 1.2798
SERVING_MIXED_BURST_THROUGHPUT_QPS_REF: float | None = 7.623
SERVING_MIXED_BURST_LATENCY_P95_S_REF: float | None = 25.70939063001424
SERVING_LONG_PROMPT_TOKENS_MIN_REF: float | None = 684
SERVING_LONG_COMPLETION_TOKENS_MIN_REF: float | None = 270.0
SERVING_LONG_LATENCY_P95_S_REF: float | None = 28.912055992987007
SERVING_LONG_AUDIO_DURATION_MIN_S_REF: float | None = 10.52
SERVING_LONG_OUTPUT_TOK_PER_REQ_S_REF: float | None = 123.2
