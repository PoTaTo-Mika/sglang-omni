...
class DotsAudioCodec:
    ...
    def __init__(self, checkpoint: str, *, device: str) -> None:
        ...
        # note (luojiaxuan): Reference encoding and vocoder decoding use
        # disjoint modules. Vocoder calls remain serialized because
        # VocoderInference owns mutable streaming state caches.
