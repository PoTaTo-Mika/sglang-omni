...
class BenchmarkRunner:
    ...
    async def run(self, samples: list, send_fn: SendFn) -> list[RequestResult]:
        ...
        # Closed-loop runs are bounded by max_concurrency. Open-loop
        # (max_concurrency=0) must not inherit aiohttp's default 100-conn cap,
        # or sustained overshoot silently queues on the client.
        connector = (
